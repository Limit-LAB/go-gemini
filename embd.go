...
func (c *Client) EmbedContent(model models.EmbeddingModel, content []models.Part) (models.EmbeddingValue, error) {
...
func (c *Client) BatchEmbedContent(model models.EmbeddingModel, contents [][]models.Part) ([]models.EmbeddingValue, error) {
